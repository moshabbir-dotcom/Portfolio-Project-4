...
This functionality works and resulted in a redirect to a successful submission page informing the user the contact for has been successfully submitted.

### Booking
* This is a page that was set to only be viewed when the user is logged in and was set using the allauth decorator of "login_required" in the views.py file to ensure that it coulds not be accessed by writing the url directly in the address bar.The links for this page were as the homepage in that across the website they were embedded in "if" statements where the links to this page would only be visible in the event the user was authenticated. Otherwise the user would be directed to the signup page to first make an account. This functionality works and resulted in a redirect to a successful submission page informing the user the contact for has been successfully submitted.
The edit and delete functions also work and on the page refresh it is visible to the user that a booking has been deleted by it disappearing from the list of bookings or in the case or amending a booking the information of the new booking overides the previous information. For future projects, the use of toast would be utilised to create a better UX
...
* [BEFORE](https://github.com/moshabbir-dotcom/Portfolio-Project-4/blob/6db9e2367b2004570febd4ff342429862fc1577b/media/images/Django32VUL.png)
* [AFTER](https://github.com/moshabbir-dotcom/Portfolio-Project-4/blob/6db9e2367b2004570febd4ff342429862fc1577b/media/images/Django3212SAFE.png)
